...
CREATE TABLE IF NOT EXISTS movimientos_arka.novedad_elemento (
    id SERIAL NOT NULL,
    vida_util NUMERIC(20,7) NOT NULL,
    valor_libros NUMERIC(20,7) NOT NULL,
    valos_residual NUMERIC(20,7) NOT NULL,
    metadata JSONB,
...
ALTER TABLE movimientos_arka.elementos_movimiento
    ADD COLUMN IF NOT EXISTS vida_util NUMERIC(20,7) NOT NULL DEFAULT 60,
    ADD COLUMN IF NOT EXISTS valor_residual NUMERIC(20,7) NOT NULL DEFAULT 0;
